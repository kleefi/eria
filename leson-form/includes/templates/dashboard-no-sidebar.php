...
<div id="adminmenumain" role="navigation" aria-label="Main menu" style="display:none;">
    ...
    <div id="adminmenuwrap">
        ...
        <div id="wpcontent" style="margin-left: 0px;">
            <main class="sui-wrap">
                <nav class="navbar-custom-menu navbar navbar-expand-lg m-0" style="left: 0px;z-index: 999;">
                    <!-- <div class="sidebar-toggle-icon" id="sidebarCollapse">
                        back<span></span>
                    </div> -->
                    <!--/.sidebar toggle icon-->
                    <div class="">
                        <!-- <p class="icon-item-title"><span class="sui-icon-chevron-left sui-lg" aria-hidden="true"></span><strong>Back</strong></p> -->
                        <a href="<?php echo network_site_url( '/dashboard-members/product-list/' ) ?>" role="button" class="sui-button sui-button-white">
...
<?php the_content(); ?>
    ...
    <!-- </div>
                            ...
                            <footer id="sample-footer--free" style="/* display: none; */" aria-hidden="true">
                                <div id="sui-cross-sell-footer" class="sui-row" style="margin-bottom: 0;">
                                    <div><span class="sui-icon-plugin-2"></span></div>
                                </div>
                                <div class="sui-footer" style="margin-top: 0;">Made with <span class="sui-icon-heart"></span> by <a href="https://www.monoplustudio.com" target="_blank">Leson Form</a></div>
                            </footer>
                            <!-- <?php
